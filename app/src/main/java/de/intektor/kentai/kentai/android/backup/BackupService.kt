...
class BackupService : Service() {
    ...
    companion object {
        ...
        val DRIVE_SHARED_PREFERENCES = "kentai.drive.preferences"
    ...
    fun createAndUploadBackup(backupName: String, kentaiClient: KentaiClient) {
        ...
        val builder = NotificationCompat.Builder(this, "kentai_progress")
        ...
        thread {
            ...
            val mediaContent = FileContent("application/kentai.backup.zip", backupFile)
