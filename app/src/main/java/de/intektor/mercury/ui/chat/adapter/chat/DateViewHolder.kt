 ...
 * @author Intektor
 */
class DateViewHolder(itemView: View, chatAdapter: ChatAdapter) : AbstractViewHolder<DateInfo>(itemView, chatAdapter) {
    ...
    override fun bind(component: ChatAdapter.ChatAdapterWrapper<DateInfo>) {
