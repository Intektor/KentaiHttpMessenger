...
object PushNotificationUtil {
    ...
    private fun popNotifications(context: Context, previousNotifications: List<NotificationHolder>, notificationManager: NotificationManagerCompat) {
    ...
    private fun popNotificationSDKUnderNougat(context: Context, list: List<NotificationHolder>, notificationManager: NotificationManagerCompat) {
    ...
    fun popNotificationSDK24(context: Context, list: List<NotificationHolder>, notificationManager: NotificationManagerCompat) {
        ...
        for ((chatUUID, notifications) in groupedByChat) {
            ...
            stackBuilder.addNextIntent(Intent(context, OverviewActivity::class.java))
    ...
    private fun writeNotificationToDatabase(dataBase: SQLiteDatabase, chatMessage: ChatMessage, chatUUID: UUID, time: Long) {
    ...
    private fun clearPreviousNotificationOfChat(dataBase: SQLiteDatabase, chatUUID: UUID) {
    ...
    private fun getNotificationIdForChat(context: Context, chatUUID: UUID): Int {
