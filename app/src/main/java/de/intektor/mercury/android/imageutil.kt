...
fun saveImageExternalMercury(name: String, bitmap: Bitmap, context: Context) {
    File(Environment.getExternalStorageDirectory().toString() + "/Pictures/Mercury/").mkdirs()
    val path = Environment.getExternalStorageDirectory().toString() + "/Pictures/Mercury/$name.jpg"
